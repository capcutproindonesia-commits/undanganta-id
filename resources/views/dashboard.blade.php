            ...
            @forelse($invitations->take(5) as $i)
                ...
                <div class="fd-row">
                    ...
                    <div class="fd-actions">
                        ...
                        @if($i->studio_template_id)
                            <a
                                href="{{ route('studio.invitation.open', $i) }}"
                        ...
                        @if($i->is_published)
                            <a
                                href="{{ $i->studio_template_id
                                    ? route('studio.invitation.preview', $i)
                                    : route('public.invitation', $i->slug)
                                }}"
                                target="_blank"
                                class="fd-action"
                            >
